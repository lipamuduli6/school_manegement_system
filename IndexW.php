...
<body>
    ...
    <h1 class="text-ceneter">STUDENT FORM</h1>
    <a href="N_display.php">View</a>
    <form action="" method="post">
        <input type="text" placeholder="Enter Your name" required autocomplate="off" name="username">
        <input type="email" placeholder="Enter Your email " required autocomplate="off" name="email">
        <input type="mobile" placeholder="Enter Your mobile number " required autocomplate="off" name="mobile">
        <input type="address" placeholder="Enter Your address " required autocomplate="off" name="address">
